...
const usersRouter = require('./controllers/User-c/users')
const adminUsersRouter = require('./controllers/User-c/admin-users')
const establishmentUsersRouter = require('./controllers/User-c/establishment-users')
const individualUsersRouter = require('./controllers/User-c/individual-users')
...
app.use('/api/establishment-user', establishmentUsersRouter)
app.use('/api/individual-user', individualUsersRouter)
